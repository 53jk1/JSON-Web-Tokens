...
const testBase64Decoded = base64UrlDecode(testBase64Encoded);
...
function generateRSAPairKeys() {
    ...
    const publicDer =''; // TODO:2 użycie funkcji zwracajacej klucz publiczny
...
const testRSA512Decrypted = "" // TODO:3 użycie funkcji dekodującej za pomoca klucza publicznego
...
function decodeJWT(token) {
    ...
    const payloadDecoded = ""; // TODO:4 użycie funkcji dekodującej base64
...
function verifyJWT(jwtSignedToken, key) {
    ...
    if (headerDecoded.alg === "HS256") {
        const jwtToken = headerEncoded + '.' + payloadEncoded;
